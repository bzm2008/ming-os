...
def load_config(path=None, last_good_path=None):
    ...
    if path == config_path() or last_good_path is not None:
        fallback = _read_config(pathlib.Path(last_good_path or last_good_config_path()))
